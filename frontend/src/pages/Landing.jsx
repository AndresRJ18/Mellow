        ...
        {!loading && (
          ...
          >
            {user ? (
              ...
              <>
                {/* Google CTA — sombra sólida neobrut */}
                <button
                ...
                <button
                  onClick={() => navigate('/onboarding')}
                  className="flex items-center gap-2 px-10 py-4 rounded-full border-2 border-zinc-700 text-zinc-400 text-sm font-black uppercase tracking-[0.12em] transition-all duration-200 hover:border-zinc-400 hover:text-zinc-100 active:scale-95"
                >
